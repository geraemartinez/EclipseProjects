...
private static Logger logger = Logger.getLogger(EventService.class);
	...
	public List<EventVo> getAllEvents() {
		try {
			...
			if (events!=null && !events.isEmpty()){
				...
				result =  EventHelper.converToVo(events);
				return result;				
			}
	...
	public EventVo getEventById(EventVo event) {
		try {
			...
			logger.error("[ERROR] Uncaught Exception - the following error ocurred at EventService getEventById() method : " + e.getMessage());
		}
		return null;
	}
	...
	public DeviceVo getDeviceEvent(EventVo event) {
		...
		try {
			...
			logger.error("[ERROR] Uncaught Exception - the following error ocurred at EventService getDeviceEvent() method : " + e.getMessage());
		}
		return null;
	}
	...
	public GeofenceVo getGeofenceEvent(EventVo event) {
		...
		try {
			...
			logger.error("[ERROR] Uncaught Exception - the following error ocurred at EventService getGeofenceEvent() method : " + e.getMessage());
		}
		return null;
	}
	...
	public MaintenanceVo getMaintenanceEvent(EventVo event) {
		try {
			...
			logger.error("[ERROR] Uncaught Exception - the following error ocurred at EventService getMaintenanceEvent() method : " + e.getMessage());
		}
		return null;
	}
	...
	public PositionVo getPositionEvent(EventVo event) {
		try {
			...
			logger.error("[ERROR] Uncaught Exception - the following error ocurred at EventService getPositionEvent() method : " + e.getMessage());
		}
		return null;
	}
