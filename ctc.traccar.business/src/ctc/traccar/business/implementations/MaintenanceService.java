...
public class MaintenanceService implements MaintenanceServiceInt {
	...
	public MaintenanceVo getMaintenanceById(MaintenanceVo ma) {
		try {
			...
			logger.error("[ERROR] Uncaught Exception - the following error ocurred at MaintenanceService getMaintenanceById() method : " + e.getMessage());
		}
		return null;
	}
	...
	public DeviceVo getDeviceOfMaintenance(MaintenanceVo ma) {
		try {
			...
			logger.error("[ERROR] Uncaught Exception - the following error ocurred at MaintenanceService getDeviceOfMaintenance() method : " + e.getMessage());
		}
		return null;
	}
